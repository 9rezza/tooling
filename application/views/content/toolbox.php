      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card ">
            ...
            <div class="card-body ">
            <div class="relbox">
              <img class="lemari-bg" src="<?=base_url('assets/images/backgrounds/'.$lemari->b_background)?>" alt="">
              <img class="tool" src="<?=base_url('assets/images/backgrounds/'.$lemari->b_background)?>" alt="">
              <img class="tool" src="<?=base_url('assets/images/backgrounds/'.$lemari->b_background)?>" alt="">
              <img class="tool" src="<?=base_url('assets/images/backgrounds/'.$lemari->b_background)?>" alt="">
              <img class="tool" src="<?=base_url('assets/images/backgrounds/'.$lemari->b_background)?>" alt="">
              <img class="" style="position: relative; width: 100%; z-index: 3" src="<?=base_url('assets/images/backgrounds/'.$lemari->b_background)?>" alt="">
            </div>
            </div>
